          ...
          <div class="col-md-6 pr-md-5">
            <form id="signup_form" onsubmit="return false" class="was-validated">
              ...
              <div class= "from-group">
                <input value="Payment" type="submit" name="payment_button" herf="event-management-master\payment.php" class=" btn btn-primary py-3 px-4"  onclick="payment"  a herf="event-management-master\payment.php" > >
               <!-- <a href="event-management-master\payment.php">Payment</a>  -->
              </div> <br>
              <div class="form-group">
