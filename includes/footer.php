      ...
      <div class="container">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="" class="py-2 d-block">Avout Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">LittleFox@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://rrce.org" target="_blank">LittleFox</a>
  </p>
          </div>
        </div>
      </div>
