    ...
    <div class="container" id="0">
      <div class="row justify-content-start mb-5 pb-3">
        <div class="col-md-7 heading-section ftco-animate">
          ...
          <h2 class="mb-4"><strong>Book Your</strong> Faviourate College Event</h2>
        </div>
      </div>
                                   ...
                                   <div class='destination'>
                                     ...
                                     <div class='text p-3'>
                                       ...
                                       <p class='bottom-area d-flex'>
                                         <span><i class='icon-map-o'></i> Luffy</span> 
              ...
              <div class="carousel-testimony owl-carousel">
                <div class="item">
                  <div class="testimony-wrap d-flex">
                    ...
                    <div class="text ml-md-4">
                      <p class="mb-5">Dr .R.Balakrishna is currently working as a Professor & Principal, Dept. of  and Engineering since 2010. His research and professional career spans about 15 years of Teaching & research, 1 Year Industrial Experience at TCS. His expertise is primarily in the domains of Ad hoc Networks, Mobile Computing, Networks, and Distributed OS.</p>
                ...
                <div class="item">
                  <div class="testimony-wrap d-flex">
                    ...
                    <div class="text ml-md-4">
                      <p class="mb-5">Naveen N C ,The Department of Computer Science & Engineering Department of JSS Academy of Technical Education, Bengaluru has been setting exemplary standards since its inception and is well on course to continue the tradition for years to come. The students are encouraged to take up challenging projects and to publish their work in various International journals. All students are mentored to make them follow a philosophy that does not set boundaries to their ability to learn. Department places a strong emphasis on imparting practical education by carefully administering proper lab work to complement their theoretical knowledge.</p>
                      <p class="name">Dr.Naveen N C</p>
